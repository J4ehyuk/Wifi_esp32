...
#   N   = window 개수
#   300 = 시간 길이, 3초 * 100Hz
#   52  = 한 시점의 feature 개수, 현재 RX 1개 * 서브캐리어 52개
#
# y shape: (N,)
#   각 window의 정답 클래스 번호
...
class LSTMClassifier(nn.Module):
    ...
    def __init__(
        ...
        # 평가할 때는 lstm.eval()을 호출하면 Dropout이 자동으로 꺼진다.
    ...
    def forward(self, x):
        ...
        # PyTorch에서는 lstm(batch_x)를 호출하면 내부적으로 forward(batch_x)가 실행된다.
        #
        # x: (batch, 300, 52)
