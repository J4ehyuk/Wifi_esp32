...
- 3-RX 전처리 설계: [preprocessing-improvement-plan.md](../model_train/lstm/preprocessing-improvement-plan.md)
- 전처리 shape와 예시: [preprocessing.md](../model_train/lstm/preprocessing.md)
