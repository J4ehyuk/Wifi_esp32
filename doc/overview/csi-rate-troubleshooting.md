...
- **추기 (2026-05-23, 커밋 `237dd75`)**: 위 결론에 언급된 PoC의 HT40 설정은 이후 **HT20으로 전환**됨 (64 서브캐리어 모델 입력에 맞추기 위해 raw 128B로 축소). 100Hz 달성에는 영향 없음. 현재 설정은 [csi-poc.md](../firmware/csi-poc.md) 참조.
